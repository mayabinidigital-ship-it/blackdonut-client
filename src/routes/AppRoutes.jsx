...
import ViewUserProfile from '../pages/general/ViewUserProfile';
      ...
      <SocketProvider>
        <ChatProvider>
          ...
          <Routes>
              ...
              <Route path="/food-partner/profile" element={<><FoodPartnerProfile/> <BottomNav roleLabel="foodPartner" /></>} />
              <Route path="/user/profile" element={<UserProfile />} />
              <Route path="/profile/user/:id" element={<ViewUserProfile />} />
