...
const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    AUTH: {
      ...
      UPDATE_USER_PROFILE: '/api/auth/user/update-profile',
    ...
    // Chat Routes
    CHAT: {
      USER_CONVERSATIONS: '/api/chat/user/conversations',
      INIT_CONVERSATION: (foodPartnerId) => `/api/chat/user/conversation/${foodPartnerId}`,
      GET_STATUS: (foodPartnerId) => `/api/chat/user/conversation/${foodPartnerId}/status`,
      GET_MESSAGES: (conversationId) => `/api/chat/messages/${conversationId}`,
      PARTNER_CONVERSATIONS: '/api/chat/partner/conversations',
      PARTNER_MESSAGES: (conversationId) => `/api/chat/partner/messages/${conversationId}`,
      ACCEPT: (id) => `/api/chat/partner/conversation/${id}/accept`,
      REJECT: (id) => `/api/chat/partner/conversation/${id}/reject`,
      RESTRICT: (id) => `/api/chat/partner/conversation/${id}/restrict`,
    },
  },
};
